...
class BeneficiaryController extends Controller
{
    ...
    {
        $results = [
            'without_cache' => $this->getActiveBeneficiariesSansCache()['queries'],
            'with_cache' => $this->getActiveBeneficiariesWithCache()['queries'],
            // 'with_flexible_cache' => $this->performQueriesWithFlexibleCache(),
        ];
